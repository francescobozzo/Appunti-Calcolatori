...
Un ulteriore miglioramento è effettuato dalla \acrfull{ddrsdram}: essa permette il trasferimento dei dati sia sul fronte di salita che sul fronte di discesa del clock della memoria. In poche parole ciò permette di raddoppiare le prestazioni rispetto ad una normale \qcrshort{dram} sincrona, e nonostante la latenza rimanga invariata, la banda viene raddoppiata.
