...
Le DRAM che sono state affrontate fin'ora sono dette \emph{asincrone}, in quanto non esiste una precisa temporizzazione di accesso, ma la dinamica viene governata dai segnali RSA e CAS. Si noti che questa asincronicità può causare non pochi problemi, soprattutto quando si esegue il refresh della memoria. Una soluzione consiste nell'aggiungere dei buffer di memorizzazione
