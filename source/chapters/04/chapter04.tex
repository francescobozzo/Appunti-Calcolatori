...
\begin{itemize}
	\item \emph{AND}: produce 1 se entrambi gli operandi sono 1, 0 altrimenti. Solitamente si indica con \(A\cdot B\).
	\item \emph{OR}: produce 0 se entrambi gli operandi sono 0, 1 altrimenti. Solitamente si indica con \(A+B\).
