...
Quindi ci conviene assolutamente costruire una sintassi dedicata all'esecuzione di operazioni con costanti, dove la \emph{i} sta per \emph{immediate}. Ad esempio \(f = f + 4\) diventa: \mintinline[escapeinside=||]{asm}{addi |$\textdollar$|s3, |$\textdollar$|s3, 4}.
