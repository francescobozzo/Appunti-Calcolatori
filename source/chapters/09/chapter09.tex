...
Proponiamo ora la traduzione che \register{gcc} esegue attivando il comando \emph{-foptimize-sibling-calls}, la cui funzione è ottimizzare le chiamate in coda:
\subsubsection{Implementazione MIPS}
