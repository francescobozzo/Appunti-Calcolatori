...
In ARM i registri sono 16 a 32 bit\footnote{Anche se ultimamente se ne vedono pure a 64 bit... \emph{non ci sono più i registri di una volta}}. I registri sono nominati da \register{r0} a \register{r15} (è scomparso l'orribile simbolo di demarcazione \$) ed alcuni di essi hanno,generalmente, funzioni specifiche, ovvero:
