...
\begin{itemize}
	...
	\item \texttt{<scale>} è \(1\), \(2\), \(4\) o \(8\)\footnote{Attenzione: al momento della pubblicazione del nostro elaborato, la dispensa "Piccola introduzione al Linguaggio Assembly e altre Simili Amenità" di Abeni riporta la notazione errata}.
\end{itemize}
