...
\begin{itemize}
	...
	\item simboli non definiti: (undefined) presenti nella tabella dei simboli ma dichiarati in un file diverso, quidi presenti appunto solo come undefined.\footnote{Nel caso un simbolo non locale non venga trovato nei file \extension{o} linkati viene generato un errore di linking}.
\end{itemize}
